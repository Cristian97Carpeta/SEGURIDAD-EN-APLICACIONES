def cifrar_letra(letra: str, clave: int) -> str:
    ...
    """
    ABC: str = 'AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz'  # Definir el alfabeto en formato AaBbCc...XxYyZz
    if letra in ABC:  # Verificar si la letra está en el alfabeto
        ...
        return ABC[(idx_letra + clave) % 52]  # Calcular y retornar la letra cifrada
    else:
...
def main():
    ...
    mensaje = "LlGaMos A InTeR"  # Definir el mensaje a cifrar
